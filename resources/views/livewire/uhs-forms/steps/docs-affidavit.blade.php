            ...
            <div class="md:mr-4">
                <ol>
                    <li class="pt-3 text-lg font-normal flex flex-row"><span
                        ...
                        <p> All students are advised to carefully read 
                            <span class="text-xl font-medium text-black">General Instructions for
                                Candidates Regarding Attachments and Attestations, </span> before
                            uploading documents.
                        </p>
                    </li>
                    <li class="pt-3 text-lg font-normal flex flex-row"><span
                            class="text-blue-900  pr-3"><x-heroicon-s-light-bulb class="h-6 w-6 text-blue-800" />
                        </span> Documents should be in JPG/JPEG format, with a file size not exceeding 1 MB per document. Apps like CamScanner can be used for this purpose.
                    </li>

                    <li class="pt-3 text-lg font-normal flex flex-row"><span
                                class="text-blue-900  pr-3"><x-heroicon-s-light-bulb class="h-6 w-6 text-blue-800" />
                        </span> 
                        <span> Upload the original documents, except for the SSC and HSSC result cards. For these, upload photocopies that have been attested by the relevant Board of Intermediate and Secondary Education. Ensure that each uploaded image is clear and legible.
                        </span>
                    </li>
                    ...
                    <li class="pt-3 text-lg font-normal flex flex-row"><span
                            class="text-blue-900  pr-3"><x-heroicon-s-light-bulb class="h-6 w-6 text-blue-800" />
                        </span>  Save each document with a unique name, and double-check before uploading.

                    </li>

                    <li class="pt-3 text-lg font-normal flex flex-row"><span
                            class="text-blue-900  pr-3"><x-heroicon-s-light-bulb class="h-6 w-6 text-blue-800" />
                        </span>  For documents in languages other than English or Urdu, official notarized/certified English translations must be provided
                    </li>
