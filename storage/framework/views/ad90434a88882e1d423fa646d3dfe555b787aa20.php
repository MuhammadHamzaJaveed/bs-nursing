...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.link','data' => ['darkMode' => $darkMode,'tag' => $tag,'wire:click' => $wireClick,'href' => $href,'target' => $target,'disabled' => $disabled,'color' => $color,'tooltip' => $tooltip,'icon' => $icon,'size' => $size,'dusk' => $dusk,'class' => $class,'iconPosition' => $iconPosition]]); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\bs-nursing\storage\framework\views/2a93415eebe11ae0654f3bf341db32239f9642df.blade.php ENDPATH**/ ?>