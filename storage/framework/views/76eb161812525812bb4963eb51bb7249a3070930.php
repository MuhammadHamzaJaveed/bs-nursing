...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.icon-button','data' => ['icon' => 'heroicon-o-filter','label' => __('tables::table.buttons.filter.label'),'indicator' => $indicatorsCount,'attributes' => $attributes->class(['filament-tables-filters-trigger'])]]); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\bs-nursing\vendor\filament\tables\src\/../resources/views/components/filters/trigger.blade.php ENDPATH**/ ?>