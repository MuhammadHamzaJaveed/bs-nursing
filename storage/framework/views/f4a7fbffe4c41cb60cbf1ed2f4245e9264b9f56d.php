...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['darkMode' => $darkMode,'form' => $form,'tag' => $tag,'wire:click' => $wireClick,'href' => $href,'target' => $target,'type' => $type,'color' => $color,'keyBindings' => $keyBindings,'tooltip' => $tooltip,'disabled' => $disabled,'icon' => $icon,'size' => $size,'labelSrOnly' => $labelSrOnly,'dusk' => $dusk,'class' => $class,'outlined' => $outlined,'iconPosition' => $iconPosition]]); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\bs-nursing\storage\framework\views/341f9ec475ab4012a909ad8432407e0c913398a1.blade.php ENDPATH**/ ?>