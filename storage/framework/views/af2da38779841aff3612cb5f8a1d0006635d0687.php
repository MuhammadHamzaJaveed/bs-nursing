...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.stats.card','data' => ['tag' => $url ? 'a' : 'div','chart' => $getChart(),'chartColor' => $getChartColor(),'color' => $getColor(),'icon' => $getIcon(),'description' => $getDescription(),'descriptionColor' => $getDescriptionColor(),'descriptionIcon' => $getDescriptionIcon(),'descriptionIconPosition' => $getDescriptionIconPosition(),'href' => $url,'target' => $shouldOpenUrlInNewTab() ? '_blank' : null,'label' => $getLabel(),'value' => $getValue(),'extraAttributes' => $getExtraAttributes(),'class' => 'filament-stats-overview-widget-card']]); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\bs-nursing\vendor\filament\filament\src\/../resources/views/widgets/stats-overview-widget/card.blade.php ENDPATH**/ ?>