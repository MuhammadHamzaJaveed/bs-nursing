...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.field-wrapper.index','data' => ['id' => $id,'label' => $label,'labelSrOnly' => $labelSrOnly,'hasNestedRecursiveValidationRules' => $hasNestedRecursiveValidationRules,'helperText' => $helperText,'hint' => $hint,'hintAction' => $hintAction,'hintColor' => $hintColor,'hintIcon' => $hintIcon,'required' => $required,'statePath' => $statePath]]); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\bs-nursing\storage\framework\views/e7490b8001308169b35d2fcec6317b67f3602de9.blade.php ENDPATH**/ ?>