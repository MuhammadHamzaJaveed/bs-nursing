...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.layouts.app.sidebar.item','data' => ['active' => $item->isActive(),'icon' => $item->getIcon(),'iconColor' => $item->getIconColor(),'activeIcon' => $item->getActiveIcon(),'url' => $item->getUrl(),'badge' => $item->getBadge(),'badgeColor' => $item->getBadgeColor(),'shouldOpenUrlInNewTab' => $item->shouldOpenUrlInNewTab()]]); ?>
...
<?php endif; ?>
            ...
            <?php elseif($item instanceof \Filament\Navigation\NavigationGroup): ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.layouts.app.sidebar.group','data' => ['label' => $item->getLabel(),'icon' => $item->getIcon(),'collapsible' => $item->isCollapsible(),'items' => $item->getItems(),'parentGroup' => (filled($parentGroup) ? ('$parentGroup' . '.') : null) . $label]]); ?>
...
<?php /**PATH C:\laragon\www\bs-nursing\vendor\filament\filament\src\/../resources/views/components/layouts/app/sidebar/group.blade.php ENDPATH**/ ?>