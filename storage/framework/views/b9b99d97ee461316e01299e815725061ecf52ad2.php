...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.icon-button','data' => ['wire:click' => 'previousPage(\'' . $paginator->getPageName() . '\')','rel' => 'prev','icon' => $previousArrowIcon,'label' => __('tables::table.pagination.buttons.previous.label')]]); ?>
...
<?php endif; ?>
        ...
        <?php if(count($recordsPerPageSelectOptions) > 1): ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.pagination.records-per-page-selector','data' => ['options' => $recordsPerPageSelectOptions]]); ?>
...
<?php endif; ?>
        ...
        <div class="w-10">
            <?php if($paginator->hasPages() && $paginator->hasMorePages()): ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.icon-button','data' => ['wire:click' => 'nextPage(\'' . $paginator->getPageName() . '\')','rel' => 'next','icon' => $nextArrowIcon,'label' => __('tables::table.pagination.buttons.next.label')]]); ?>
<?php $component->withName('tables::icon-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
        ...
        <div class="flex items-center">
            <?php if($isSimple): ?>
                <?php if(! $paginator->onFirstPage()): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.button','data' => ['wire:click' => 'previousPage(\'' . $paginator->getPageName() . '\')','icon' => $previousArrowIcon,'rel' => 'prev','size' => 'sm','color' => 'secondary']]); ?>
        ...
        <div class="flex items-center justify-end">
            <?php if($isSimple): ?>
                <?php if($paginator->hasMorePages()): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.button','data' => ['wire:click' => 'nextPage(\'' . $paginator->getPageName() . '\')','icon' => $nextArrowIcon,'iconPosition' => 'after','rel' => 'next','size' => 'sm','color' => 'secondary']]); ?>
<?php $component->withName('tables::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
                ...
                <?php if($paginator->hasPages()): ?>
                    ...
                    >
                        ...
                        >
                            <?php if(! $paginator->onFirstPage()): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.pagination.item','data' => ['wire:click' => 'previousPage(\'' . $paginator->getPageName() . '\')','icon' => 'heroicon-s-chevron-left','ariaLabel' => ''.e(__('tables::table.pagination.buttons.previous.label')).'','rel' => 'prev']]); ?>
...
<?php endif; ?>
                            ...
                            <?php $__currentLoopData = $paginator->render()->offsetGet('elements'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(is_string($element)): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.pagination.item','data' => ['label' => $element,'disabled' => true]]); ?>
<?php $component->withName('tables::pagination.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                            ...
                            <?php if($paginator->hasMorePages()): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.pagination.item','data' => ['wire:click' => 'nextPage(\'' . $paginator->getPageName() . '\')','icon' => 'heroicon-s-chevron-right','ariaLabel' => ''.e(__('tables::table.pagination.buttons.next.label')).'','rel' => 'next']]); ?>
<?php $component->withName('tables::pagination.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php /**PATH C:\laragon\www\bs-nursing\vendor\filament\tables\src\/../resources/views/components/pagination/index.blade.php ENDPATH**/ ?>