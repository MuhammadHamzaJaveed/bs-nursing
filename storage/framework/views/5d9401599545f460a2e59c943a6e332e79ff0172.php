...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'notifications::components.modal.index','data' => ['id' => 'database-notifications','closeButton' => true,'slideOver' => true,'width' => 'md']]); ?>
...
<?php $component->withAttributes(['id' => 'database-notifications','close-button' => true,'slide-over' => true,'width' => 'md']); ?>
    <?php if($notifications->count()): ?>
         <?php $__env->slot('header', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'notifications::components.database.modal.heading','data' => ['unreadNotificationsCount' => $unreadNotificationsCount]]); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'notifications::components.database.modal.actions','data' => ['notifications' => $notifications,'unreadNotificationsCount' => $unreadNotificationsCount]]); ?>
...
<?php endif; ?>
    ...
    <?php else: ?>
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'notifications::components.database.modal.empty-state','data' => []]); ?>
