...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.layouts.app.topbar.breadcrumbs','data' => ['breadcrumbs' => $breadcrumbs]]); ?>
...
} elseif ($_instance->childHasBeenRendered('eZpF8Bu')) {
    $componentId = $_instance->getRenderedChildComponentId('eZpF8Bu');
    $componentTag = $_instance->getRenderedChildComponentTagName('eZpF8Bu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eZpF8Bu');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('eZpF8Bu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('THSLFVj')) {
    $componentId = $_instance->getRenderedChildComponentId('THSLFVj');
    $componentTag = $_instance->getRenderedChildComponentTagName('THSLFVj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('THSLFVj');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('THSLFVj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.layouts.app.topbar.user-menu','data' => []]); ?>
...
<?php /**PATH C:\laragon\www\bs-nursing\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>